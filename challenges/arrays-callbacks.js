...
// }
function iterate(){
  return `Name: ${zooAnimals[i]['animal_name']}, Scientific: ${zooAnimals[i]['scientific_name']}`
}
displayNames.forEach(iterate);
...
*/
let populationTotal = zooAnimals.reduce(function(adder, element){
